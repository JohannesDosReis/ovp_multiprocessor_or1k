...
int main(int argc, char **argv) {
    ...
    icmProcessorP processor3 = icmNewProcessor("cpu3",       // CPU name
                                               "or1k",       // CPU type
                                               3,            // CPU cpuId
                                               0,            // CPU model flags
                                               32,           // address bits
    ...
    if (!icmLoadProcessorMemory(
            processor0,
            "C:/Users/johan/dev/upf/multiprocessor/step-3/application/application.OR1K.elf", False,
            False, True) ||
    ...
    icmPrintf("processor3 has executed " FMT_64u " instructions\n",
