...
int main(int argc, char **argv) {
    ...
    const char *model =
        icmGetVlnvString(vlnvRoot, "ovpworld.org", "processor", "or1k", "1.0", "model");
    const char *semihosting =
        icmGetVlnvString(vlnvRoot, "ovpworld.org", "semihosting", "or1kNewlib", "1.0", "model");

    // create processor cpu0
    icmProcessorP processor0 = icmNewProcessor("cpu0",       // CPU name
                                               "or1k",       // CPU type
                                               0,            // CPU cpuId
                                               0,            // CPU model flags
                                               32,           // address bits
    ...
    icmProcessorP processor1 = icmNewProcessor("cpu1",       // CPU name
                                               "or1k",       // CPU type
                                               1,            // CPU cpuId
                                               0,            // CPU model flags
                                               32,           // address bits
    ...
    icmProcessorP processor2 = icmNewProcessor("cpu2",       // CPU name
                                               "or1k",       // CPU type
                                               2,            // CPU cpuId
                                               0,            // CPU model flags
                                               32,           // address bits
    ...
    if (!icmLoadProcessorMemory(
            processor0, "C:/Users/johan/Desktop/multiprocessor/application/application.OR1K.elf",
            False, False, True) ||
        !icmLoadProcessorMemory(
            processor1, "C:/Users/johan/Desktop/multiprocessor/application/application.OR1K.elf",
            False, False, True) ||
        !icmLoadProcessorMemory(
            processor2, "C:/Users/johan/Desktop/multiprocessor/application/application.OR1K.elf",
            False, False, True)) {
        return -1;
    }
    ...
    icmPrintf("processor0 has executed " FMT_64u " instructions\n",
              icmGetProcessorICount(processor0));
    icmPrintf("processor1 has executed " FMT_64u " instructions\n",
              icmGetProcessorICount(processor1));
    icmPrintf("processor2 has executed " FMT_64u " instructions\n",
